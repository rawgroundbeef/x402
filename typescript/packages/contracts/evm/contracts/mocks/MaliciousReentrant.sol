...
contract MaliciousReentrant is ISignatureTransfer {
    IX402Permit2Proxy public target;
    ...
    function setAttackParams(
        ...
        uint256 amount,
        address owner,
        IX402Permit2Proxy.Witness calldata witness,
        bytes calldata signature
    ) external {
        storedPermit = permit;
        storedAmount = amount;
